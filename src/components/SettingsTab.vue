      ...
      <div class="space-y-4">
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center justify-between">
            ...
            <input
              type="checkbox"
              v-model="displaySettings.reduceMotion"
              class="w-4 h-4"
            />
          </div>
        </div>
      ...
      <div class="space-y-4">
        ...
        <div class="p-4 border rounded-lg bg-muted">
          <p class="text-sm text-muted-foreground">
            <strong>Alter Life</strong> - A narrative-driven game about supporting your partner during pregnancy and early parenthood.
          </p>
